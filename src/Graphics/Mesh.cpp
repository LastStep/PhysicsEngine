...
void MeshSquare::Draw(std::shared_ptr<OrthographicCameraController> cameraController)
{
    m_Shader->Bind();
...
glm::vec3 MeshSquare::GetWorldPosition()
{
    glm::vec3 o_WorldPosition = m_MeshRectangleAttributes.position + m_MeshRectangleAttributes.offset;
